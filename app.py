...
def check(email):
    url = "https://ljctgts53d.execute-api.us-east-2.amazonaws.com/plasma/getdata?email="+email
...
def register():
    ...
    if('errorType' in check(x[1])):
        url = "https://ljctgts53d.execute-api.us-east-2.amazonaws.com/plasma/registration?"+params
...
@app.route('/stats')
def stats():
    url = "https://ljctgts53d.execute-api.us-east-2.amazonaws.com/plasma/getbloodgroupdata"
    response = requests.get(url)
    r = response.json()
    print(r)
...
def requested():
    ...
    #print(bloodgrp)
    url = "https://ljctgts53d.execute-api.us-east-2.amazonaws.com/plasma/requestonbloodgroup?blood="+bloodgrp
    status = requests.request("GET",url)
    a=status.json()
    print(a)
    phone=[]
